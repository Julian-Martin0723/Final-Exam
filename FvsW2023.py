...
table_data = {
    ...
    'Wilson Totals': [15, 483, 292, 3524, 142, 277, 3],
    'Fields Totals': [15, 318, 192, 2242, 91, 1143, 8],
...
# Streamlit App
st.title("Russell Wilson vs. Justin Fields 2023 Statistics")

# Display Table
st.subheader("Career 2023 Table")
st.table(df)

# Bar Chart
st.subheader("Bar Chart of 2023 Statistics")
